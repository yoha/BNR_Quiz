...
class ViewController: UIViewController {
    ...
    func animateLabelTransitions() {
        ...
        UIView.animateWithDuration(0.5, delay: 0.0, usingSpringWithDamping: 0.6, initialSpringVelocity: 2.0, options: [UIViewAnimationOptions.CurveEaseInOut], animations: { () -> Void in
